<?php 
	...
	class CentrocostoModel extends Mysql
	{
		public $intIdcentrocosto;
		public $strNombrecentrocosto;
		...
		public function selectCentrocosto()
		{
			$whereAdmin = "";
			...
			//EXTRAE ROLES
			$sql = "SELECT * FROM centro_costo WHERE status != 0".$whereAdmin;
